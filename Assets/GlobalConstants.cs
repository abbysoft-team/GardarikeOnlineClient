...
public class GlobalConstants
{
    ...
    public const float CHUNK_SIZE = 2222f;
    public const float CHUNK_HEIGHT = 555f;
    ...
    public const int MIN_CAMERA_Y = 400;
    public const int MAX_CAMERA_Y = (int) (GlobalConstants.CHUNK_HEIGHT * 1.5f);
